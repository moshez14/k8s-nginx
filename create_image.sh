...
# 3. Tag for ECR
sudo docker tag nginx:1.0.3 297053566157.dkr.ecr.eu-west-1.amazonaws.com/maifocus-rep:nginx-1.0.3

# 4. Push
sudo docker push 297053566157.dkr.ecr.eu-west-1.amazonaws.com/maifocus-rep:nginx-1.0.3
